class ICTUConstants {
  ...
  static const List<String> semesters = <String>[
    'Fall 2025',
    'Spring 2026',
    'Summer 2025',
  ];

  static const Map<String, String> sampleCourses = <String, String>{
  ...
  static const Set<String> supportedDepartments = <String>{
    'CSC',
    'SEN',
    'ICT',
    'CYS',
